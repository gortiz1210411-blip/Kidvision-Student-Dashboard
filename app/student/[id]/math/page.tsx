    ...
    <div className="min-h-screen bg-gradient-to-br from-[#DDEEFF] to-[#E8D4FF]">
      <header className="bg-white shadow-sm border-b border-[#E0E5F2]">
        <div className="max-w-5xl mx-auto px-6 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-[#1A2740]">Math Assessments</h1>
      ...
      <main className="max-w-5xl mx-auto px-6 py-8 space-y-6">
        <section className="bg-white rounded-2xl shadow-md p-6">
          <h2 className="text-lg font-semibold text-[#1A2740] mb-3">Recent Math Assessments</h2>
          <p className="text-sm text-[#A0A7B4]">Data will appear here when your teacher uploads math results.</p>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-md p-6">
          ...
          <ul className="list-disc list-inside text-sm text-[#A0A7B4] space-y-2">
            <li>FAST / STAR Math progress over time.</li>
            <li>Quiz and unit test highlights.</li>
            <li>Focus areas and recommended practice.</li>
          </ul>
        </section>
      </main>
    </div>
